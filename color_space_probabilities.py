...
# Convert to derived color spaces (e.g. [Red + Green] / Blue) and then
# convert to 0 - 255
...
def main():
    ...
    if Ingling:
        outFileList = outFileList \
                + ['Ingling_r_g','Ingling_b_y','Ingling_rgby','Ingling_V']
        Ingling_r_g = {}
        Ingling_b_y = {}
        Ingling_rgby = {}
        Ingling_V = {}
        outDictList = outDictList \
                + [Ingling_r_g,Ingling_b_y,Ingling_rgby,Ingling_V]
    if ExRGB:
        outFileList = outFileList \
                + ['ExRGB_R14','ExRGB_R20','ExRGB_G',
                        'ExRGB_B','ExRGB1','ExRGB2','ExRGB12']
        ExRGB_R14 = {}
        ExRGB_R20 = {}
        ExRGB_G = {}
        ExRGB_B = {}
        ...
        ExRGB12 = {}
        outDictList = outDictList \
                + [ExRGB_R14,ExRGB_R20,ExRGB_G,ExRGB_B,ExRGB1,ExRGB2,ExRGB12]
    if ATD:
        outFileList = outFileList \
                + ['ATD_A1','ATD_T1','ATD_D1','ATD_TD1',
                        'ATD_t1','ATD_d1','ATD_td1','ATD_A2',
                        'ATD_T2','ATD_D2','ATD_TD2']
        ATD_A1 = {}
        ATD_T1 = {}
        ATD_D1 = {}
        ATD_TD1 = {}
        ...
        #ATD_ATD2 = {}
        outDictList = outDictList \
                + [ATD_A1,ATD_T1,ATD_D1,ATD_TD1,ATD_t1,
                        ATD_d1,ATD_td1,ATD_A2,ATD_T2,ATD_D2,ATD_TD2]
    if NDI123:
        outFileList = outFileList \
                 + ['NDI123_1','NDI123_2','NDI123_3',
                        'NDI123_NDI12','NDI123_ND23','NDI123_NDI13']
        NDI123_1 = {}
        NDI123_2 = {}
        NDI123_3 = {}
        NDI123_NDI12 = {}
        ...
        NDI123_NDI13 = {}
        outDictList = outDictList \
                + [NDI123_1,NDI123_2,NDI123_3,NDI123_NDI12,
                        NDI123_NDI23,NDI123_NDI13]
    if i123:
        outFileList = outFileList \
                + ['i123_1','i123_2','i123_3','i123_i12','i123_i23','i123_i13']
        i123_1 = {}
        i123_2 = {}
        i123_3 = {}
        i123_i12 = {}
    ...
    # Each subfolder holds mask files that have the same
    # name as each photo, but are bmp's.
    ...
    for maskDirLocation in maskDirs:
        ...
        for maskFile in maskFileList:
            ...
            if os.path.splitext(maskPath + maskFile)[1] == '.bmp':
                ...
                # background in black
                maskImage = Image.open(maskPath + maskDirLocation \
                        + '\\' + maskFile).convert("L")
                ...
                for i in range(0, len(foreR)):
                    ...
                    if (foreR[i] > 0) and ((foreG[i] > 0) and (foreB[i] > 0)):
                        ...
                        if RGB:
                            RG[(foreR[i],foreG[i])] = \
                                    RG.get((foreR[i],foreG[i]), 0) + 1
                            RB[(foreR[i],foreB[i])] = \
                                    RB.get((foreR[i],foreB[i]), 0) + 1
                            GB[(foreG[i],foreB[i])] = \
                                    GB.get((foreG[i],foreB[i]), 0) + 1
                        ...
                        if Ingling:
                            ...
                            Ingling_rgby[(r_g,b_y)] = \
                                    Ingling_rgby.get((r_g,b_y), 0) + 1
                        ...
                        if NDI123:
                            ...
                            #NDI123_NDI123[(NDI1, NDI2, NDI3)] = \
                            #        NDI123_NDI123.get((NDI1, NDI2, NDI3), 0) + 1
                        ...
                        if i123:
                            ...
                            i123_i12[(i1, i2)] = \
                                    i123_i12.get((i1, i2),0) + 1
                            i123_i23[(i2, i3)] = \
                                    i123_i23.get((i2, i3),0) + 1
                            i123_i13[(i1, i3)] = \
                                    i123_i13.get((i1, i3),0) + 1
                            #i123_i123[(i1, i2, i3)] = \
                            #        i123_i123.get((i1, i2, i3), 0) + 1

                        if CIVE:
                            CIVE_value = \
                                    ColorConverter.rgb_to_CIVE(r, g, b, write256)
                            CIVE_dict[CIVE_value] = \
                                    CIVE_dict.get(CIVE_value, 0) + 1

                        if shadow:
                            shadow_value = \
                                    ColorConverter.rgb_to_shadow(r, g, b, write256)
                            shadow_dict[shadow_value] = \
                                    shadow_dict.get(shadow_value, 0) + 1
