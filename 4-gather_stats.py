...
def main():
    ...
    if RGBfractRGB_bool:
        csvFileList = \
                csvFileList + ['R_256', 'G_256', 'B_256', 'GR_256', 'BR_256']
    elif RGB_bool:
    ...
    if HSL_bool:
        csvFileList = \
                csvFileList + ['HSL_H_256','HSL_S_256','HSL_L_256','HSL_HS_256']
    if Yxy_bool:
        csvFileList = \
                csvFileList + ['Yxy_Y_256','Yxy_x_256','Yxy_y2_256','Yxy_xy_256']
    if NRGB_bool:
        csvFileList = csvFileList + ['NRGB_NR_256',
                                     'NRGB_NG_256',
                                     'NRGB_NB_256',
                                     'NRGB1_256',
                                     'NRGB2_256',
    ...
    if Lab_bool:
        csvFileList = \
                csvFileList + ['Lab_L_256','Lab_a_256','Lab_b_256','Lab_ab_256']
    if Ingling_bool:
        csvFileList = csvFileList + ['Ingling_r_g_256',
                                     'Ingling_b_y_256',
                                     'Ingling_rgby_256',
                                     'Ingling_V_256']
    if ExRGB_bool:
        csvFileList = csvFileList + ['ExRGB_R14_256',
                                     'ExRGB_R20_256',
                                     'ExRGB_G_256',
                                     'ExRGB_B_256',
                                     'ExRGB1_256',
                                     ...
                                     'ExRGB12_256']
    if ATD_bool:
        csvFileList = csvFileList + ['ATD_A1_256',
                                     'ATD_T1_256',
                                     'ATD_D1_256',
                                     'ATD_TD1_256',
                                     'ATD_t_256',
                                     ...
                                     'ATD_TD2_256']
    if NDI123_bool:
        csvFileList = csvFileList + ['NDI123_1_256',
                                     'NDI123_2_256',
                                     'NDI123_3_256',
                                     'NDI123_NDI12_256',
                                     'NDI123_NDI23_256',
                                     'NDI123_NDI13_256']
    if i123_bool:
        csvFileList = csvFileList + ['i123_1_256',
                                     'i123_2_256',
                                     'i123_3_256',
                                     'i123_i12_256',
                                     'i123_i23_256',
